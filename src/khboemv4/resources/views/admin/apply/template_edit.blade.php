...
<head>
    ...
    <style>
        *{margin:0;padding:0;}
        ...
        .tmp .pay-box a{font-size: 14px;background-color: #ccc;color: #fff;border-color: #cf1010;padding: 9px 15px;border-radius: 4px;}
        .tmp .pay-box a.install{background-color: #cf1010;}
        .tmp .pay-box a.buy{background-color: #3598dc;}
    ...
    <div class="tmp">
       ...
       {{-- <div class="do-num clear mb20">
        ...
        <div class="pay-box mt20">
            @if($data->type == 'free' && !$info)
                <a href="javascript:;" class="install" date-type="install_">立即购买</a>
            @elseif($info)
                <a href="javascript:;" >已安装</a>
            @else
                <a href="javascript:;" class="buy" date-type="buy_">立即购买</a>
            @endif
        </div>
    </div>
    <script>
