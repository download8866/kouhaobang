                        ...
                        <div class="media clear">
                            ...
                            <div class="media-body app-right">
                                <h4 class="media-heading">
                                    <span class="btn btn-danger gf btn-xs">官方</span> <a href="#" target="_blank">{{$item->name}}</a>
                                </h4>
                                <p>{{$item->slogan}}</p>
                                <div class="cpt">
                                    ...
                                    @else
                                        <a href="javascript:;" class="btn blue btn-xs disBuy">已安装</a>
                                    @endif
    ...
    <script>
        $(function(){
            $('.detail').on('click',function(){
                var id = $(this).attr('id');
                var route='/admin/apply/part/'+id+'/edit';
