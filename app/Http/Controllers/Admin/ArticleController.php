...
class ArticleController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        if ($request->get('start_time')) {
            $model = $model->where('updated_at', '>', $request->get('start_time'));
        }
        if ($request->get('end_time')) {
            $model = $model->where('updated_at', '>', $request->get('end_time'));
        }
    ...
    {
        $data = $request->only(['category_id', 'title', 'keywords', 'description', 'content', 'status', 'click']);
